...
- Phone layouts are tightened across auth, onboarding, navigation, transaction review, budgets, funds, friends, profile, game progress, and feature notifications. Below 520px, the sidebar becomes a compact sticky header with horizontally scrollable modules, transaction tables become labeled cards, onboarding edit rows stack, and the feature notification modal behaves like a bottom sheet.
