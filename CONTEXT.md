...
- Wordle guesses are validated against the available full local English five-letter dictionary plus answer words, not only the 3000-word ranked game pool.
...
- The Wordle answer list is a curated common five-letter subset, while accepted guesses use the full available local five-letter English dictionary. The 3000-word ranked pool is retained as game source metadata.
